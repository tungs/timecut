...
* <a name="cli-options-canvas-mode" href="#cli-options-canvas-mode">#</a> Canvas Mode: `--canvas-mode` *\[format\]*
...
*  <a name="js-api-config" href="#js-api-config">#</a> `config` &lt;[Object][]&gt;
    ...
    * <a name="js-config-canvas-mode" href="#js-config-canvas-mode">#</a> `canvasMode` &lt;[boolean][] | [string][]&gt;
